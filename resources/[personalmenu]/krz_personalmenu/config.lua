...
-- GENERAL --
Config.MenuTitle = 'GermanGaming' -- change it to you're server name
...
-- GPS --
Config.GPS = {
	{label = 'Wegpunkt entfernen', coords = nil},
	{label = 'Polizei', coords = vector2(425.13, -979.55)},
	{label = 'Garage Central', coords = vector2(-449.67, -340.83)},
	{label = 'Krankenhaus', coords = vector2(-33.88, -1102.37)},
	{label = 'Dealer', coords = vector2(215.06, -791.56)},
	{label = 'Benny\'s Custom', coords = vector2(-212.13, -1325.27)},
	{label = 'Jobcenter', coords = vector2(-264.83, -964.54)},
	{label = 'Fahrschule', coords = vector2(-829.22, -696.99)},
