print("^0======================================================================^7")
print("^0[^4Author^0] ^7:^0 ^0GermanGaming^7")
print("^0[^3Version^0] ^7:^0 ^Template Server^7")
print("^0[^2Download^0] ^7:^0 ^5Kostenloses Download: https://discord.gg/6AkBVCa^7")
print("^0[^1YouTube^0] ^7:^0 ^5https://youtube.com/GermanGaming^7")
print("^0[^1Info^0] ^7:^0 ^5Diesen Server kann man kostenlos runterladen^7")
print("^0======================================================================^7")
